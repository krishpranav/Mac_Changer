...
print("-" * 50)
time.sleep(5)
subprocess.call("ifconfig" + inteface + "down", shell=True)
subprocess.call("ifconfig" + inteface + "hw" + "ether" + new_mac, shell=True)
subprocess.call("ifconfig" + inteface + "up", shell=True)
